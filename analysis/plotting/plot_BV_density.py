...
def main():
    ...
    plot_volume_density_barplot(bv_density_brain_region_dict, brain_region_labels, plot_output_path, dark_mode=dark_mode, left_color=(0.7529, 0.6471, 0.3882), right_color=(0.3451, 0.3137, 0.6824), tick_fontsize=17, title_fontsize=18, legend_fontsize=16)
    print("All done!")
