...
def plot_soma_counts_per_brain_region(data_per_brain_region, output_dir, left_color='skyblue', right_color='salmon'):
    brain_region_names = []
    soma_counts_l = []
    soma_counts_r = []
...
def plot_soma_density_per_brain_region(data_per_brain_region, output_dir, left_color='skyblue', right_color='salmon'):
    brain_region_names = []
    soma_densities_l = []
    soma_densities_r = []
    for brain_region_name, hemispheres in data_per_brain_region.items():
...
def plot_boxplot(data_l, data_r, brain_region_names, ylabel, title, output_path, show_outliers=True, left_color='skyblue', right_color='salmon'):
...
def plot_soma_surface_area_per_brain_region(data_per_brain_region, output_dir, show_outliers=True, left_color='skyblue', right_color='salmon'):
    brain_region_names = []
    surface_areas_l = []
    surface_areas_r = []
    for brain_region_name, hemispheres in data_per_brain_region.items():
    ...
    plot_boxplot(surface_areas_l, surface_areas_r, brain_region_names, 
                 ...
                 os.path.join(output_dir, 'soma_surface_area_per_brain_region_boxplot.png'), show_outliers=show_outliers, left_color=left_color, right_color=right_color)

def plot_soma_volume_per_brain_region(data_per_brain_region, output_dir, show_outliers=True, left_color='skyblue', right_color='salmon'):
    brain_region_names = []
    volumes_l = []
    volumes_r = []
    for brain_region_name, hemispheres in data_per_brain_region.items():
    ...
    plot_boxplot(volumes_l, volumes_r, brain_region_names, 
                 ...
                 os.path.join(output_dir, 'soma_volume_per_brain_region_boxplot.png'), show_outliers=show_outliers, left_color=left_color, right_color=right_color)

def plot_soma_convex_hull_volume_per_brain_region(data_per_brain_region, output_dir, show_outliers=True, left_color='skyblue', right_color='salmon'):
    brain_region_names = []
    ...
    plot_boxplot(convex_hull_volumes_l, convex_hull_volumes_r, brain_region_names, 
                 ...
                 os.path.join(output_dir, 'soma_convex_hull_volume_per_brain_region_boxplot.png'), show_outliers=show_outliers, left_color=left_color, right_color=right_color)

def plot_soma_max_radius_per_brain_region(data_per_brain_region, output_dir, show_outliers=True, left_color='skyblue', right_color='salmon'):
    brain_region_names = []
    max_radii_l = []
    max_radii_r = []
    for brain_region_name, hemispheres in data_per_brain_region.items():
    ...
    plot_boxplot(max_radii_l, max_radii_r, brain_region_names, 
                 ...
                 os.path.join(output_dir, 'soma_max_radius_per_brain_region_boxplot.png'), show_outliers=show_outliers, left_color=left_color, right_color=right_color)

def plot_soma_min_radius_per_brain_region(data_per_brain_region, output_dir, show_outliers=True, left_color='skyblue', right_color='salmon'):
    brain_region_names = []
    min_radii_l = []
    min_radii_r = []
    for brain_region_name, hemispheres in data_per_brain_region.items():
    ...
    plot_boxplot(min_radii_l, min_radii_r, brain_region_names, 
                 ...
                 os.path.join(output_dir, 'soma_min_radius_per_brain_region_boxplot.png'), show_outliers=show_outliers, left_color=left_color, right_color=right_color)
...
def main():
    ...
    plot_soma_counts_per_brain_region(data_per_brain_region, output_dir, left_color=left_color, right_color=right_color)
    plot_soma_density_per_brain_region(data_per_brain_region, output_dir, left_color=left_color, right_color=right_color)
    plot_soma_surface_area_per_brain_region(data_per_brain_region, output_dir, show_outliers=show_outliers, left_color=left_color, right_color=right_color)
    plot_soma_volume_per_brain_region(data_per_brain_region, output_dir, show_outliers=show_outliers, left_color=left_color, right_color=right_color)
    plot_soma_convex_hull_volume_per_brain_region(data_per_brain_region, output_dir, show_outliers=show_outliers, left_color=left_color, right_color=right_color)
    plot_soma_max_radius_per_brain_region(data_per_brain_region, output_dir, show_outliers=show_outliers, left_color=left_color, right_color=right_color)
    plot_soma_min_radius_per_brain_region(data_per_brain_region, output_dir, show_outliers=show_outliers, left_color=left_color, right_color=right_color)
