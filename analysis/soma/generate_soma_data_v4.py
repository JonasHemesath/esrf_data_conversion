...
def _init_worker(brain_regions_path, soma_path, bv_path, brain_regions_mip, region_labels_path):
    """Initializer for worker processes.

    The worker processes need their own CloudVolume handles (they are not picklable).
    """
    global _global_soma, _global_brain_regions, _global_bv, _global_brain_regions_mip, _global_brain_region_labels, _global_skeletons
...
class SomaDataGenerator:
    ...
    def iter_rows_parallel(self, num_workers=None, chunksize=10, show_progress=True):
        ...
        with multiprocessing.Pool(
            ...
            initargs=(self.brain_regions_path, self.soma_path, self.bv_path, self.brain_regions_mip, self.brain_region_labels_path),
        ) as pool:
...
if __name__ == "__main__":
    ...
    soma_data_generator = SomaDataGenerator(
        ...
        args.soma_path,
        args.bv_path,
        args.brain_regions_labels_path,
