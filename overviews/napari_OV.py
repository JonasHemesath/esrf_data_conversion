...
def main():
    ...
    #atlas_cv = CloudVolume(args.atlas, progress=True, mip=0)
    #atlas = atlas_cv[:, :, :]
    #atlas_name = str(args.atlas)
    ...
    atlas_points = load_points_from_csv(args.points_atlas)
    xray_points = load_points_from_csv(args.points_xray)
