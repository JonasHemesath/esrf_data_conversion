                ...
                for x in range(x_i, x_chunks, args.step):
                    ...
                    for y in range(y_i, y_chunks, args.step):
                        ...
                        for z in range(z_i, z_chunks, args.step):
                            ...
                            if args.export_debug:
                                processes.append(subprocess.Popen(['srun', '--time=7-0', '--gres=gpu:0', '--mem=30000', '--tasks', '1', '--cpus-per-task', '2', 'python', '/cajal/nvmescratch/users/johem/esrf_data_conversion/segmentation/masking/apply_mask_block_cloudvolume.py',
