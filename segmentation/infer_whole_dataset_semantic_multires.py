...
def main(args):
    ...
    script_path = '/cajal/nvmescratch/users/johem/esrf_data_conversion/segmentation/infer_block_semantic_multires.py'
    if args.fast:
        script_path = '/cajal/nvmescratch/users/johem/esrf_data_conversion/segmentation/infer_block_semantic_multires_fast.py'
                ...
                for x in range(x_i, x_chunks, args.step):
                    ...
                    for y in range(y_i, y_chunks, args.step):
                        ...
                        for z in range(z_i, z_chunks, args.step):
                            ...
                            if args.export_debug:
                                processes.append(subprocess.Popen(['srun', '--time=7-0', '--gres=gpu:a40:1', '--mem=400000', '--tasks', '1', '--cpus-per-task', '32', '--nice', 'python', script_path,
