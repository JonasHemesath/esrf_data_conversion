...
for x in range(x_chunks):
    ...
    for y in range(y_chunks):
        ...
        for z in range(z_chunks):
            ...
            processes.append(subprocess.Popen(['srun', '--time=7-0', '--gpu:a40:1', '--mem=400000', '--tasks', '1', '--cpus-per-task', '32', '--pty', 'python', '/cajal/nvmescratch/users/johem/esrf_data_conversion/segmentation/infer_semantic_block.py',
